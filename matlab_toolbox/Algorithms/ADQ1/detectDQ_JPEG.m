...
%         selectedCoeffs=coeffArray(startX:end, startY:end);
...
%             P_tampered(:,:,coeffIndex)=ones(ceil(size(coeffArray,1)),ceil(size(coeffArray,2)))*0.5;
